...
var
  ...
  i, j: integer;
  v1, v2: extended;
  func: (fNone, fSin, fCos, fTg, fCtg, fArcsin, fArccos, fArctg, fArcctg, fAbs, fLn, fLg2, fLg10, fExp, fSqrt);
  Sign: integer;
  s: String;
  s1: String;
...
// sin, cos, tg, ctg, arcsin, arccos, arctg, arcctg, abs, ln, lg, log, e
  repeat
    func := fNone;
    p1 := pos('sin', s);
    if p1 > 0 then begin
    ...
    case func of
      fSin, fCos, fCtg, fAbs,fLg2: i := p + 2;
      fLg10, fSqrt: i:= p + 3;
      fArctg: i := p + 4;
      fExp: i:=p;
